                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <Service
                        ...
                        <Service
                            ...
                            desc="I specialize in leveraging cloud computing to transform digital experiences. Using robust cloud technologies, I enhance system performance, scalability, and security. Let's work together to create innovative cloud solutions that users will love."
                            data={[
                                "AWS",
                                "Google Cloud",
                                "Microsoft Azure",
                        ...
                        <Service
                            ...
                            desc="I specialize in utilizing a wide range of tools and technologies to enhance digital experiences. Using Firebase, Postman, Power BI, Git, GitHub, WordPress, Notion, and Vercel, I improve system performance, scalability, and design. Let's work together to create innovative solutions that users will love."
                            data={[
                                "Git",
                                "GitHub",
                                "WordPress",
