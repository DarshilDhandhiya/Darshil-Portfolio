...
const HeroBanner = () => {
    ...
    return (
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>darshil.dhandhiya03@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Darshil Dhandhiya,</span>
                    </div>
        ...
        <a href="https://www.linkedin.com/in/darshildhandhiya/" style={iconStyle}>
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/DarshilDhandhiya" style={iconStyle}>
          <i className="fab fa-github"></i>
        </a>
        <a href="https://twitter.com/Darshil03" style={iconStyle}>
